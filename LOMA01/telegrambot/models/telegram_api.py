...
class Message(models.Model):
    ...
    from_user = models.ForeignKey(LomaUser, related_name='messages', verbose_name=_("User"), on_delete=models.CASCADE)
    date = models.DateTimeField(_('Date'))
    chat = models.ForeignKey(Chat, related_name='messages', verbose_name=_("Chat"), on_delete=models.CASCADE)
    forward_from = models.ForeignKey(LomaUser, null=True, blank=True, related_name='forwarded_from',
